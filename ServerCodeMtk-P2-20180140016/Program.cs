...
using ServiceMtk_P1_20180140016;
using System.ServiceModel.Description;
using System.ServiceModel.Channels; //mex

namespace ServerCodeMtk_P2_20180140016
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                hostObj = new ServiceHost(typeof(IMatematika1), address);
                //ALAMAT BASE ADDRESS
                hostObj.AddServiceEndpoint(typeof(IMatematika1), bind, "");
                //ALAMAT ENDPOINT
                //wsdl
